        ...
        @auth
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                    <a class="sidebar-brand brand-logo" href="{{ url('/') }}"><img src="images/PrWhats.svg"
                            alt="logo"></a>
                    <a class="sidebar-brand brand-logo-mini" href="{{ url('/') }}"><img src="images/PrWhatsMini.svg"
                            alt="logo"></a>
                </div>
                <ul class="nav">
                    ...
                    <li class="nav-item menu-items">
                        <a class="nav-link collapsed" data-toggle="collapse" href="#ui-user" aria-expanded="false"
                        ...
                        <div class="collapse" id="ui-user" style="">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('register') }}">Adicionar</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('404') }}">Editar</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="pages/ui-features/typography.html">Deletar</a></li>
                            </ul>
                    </li>
                </ul>
            </nav>
                ...
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item dropdown d-none d-lg-block">
                            <a class="nav-link btn btn-warning create-new-button"
                                href="https://www.pecararabrecho.com.br/" target="true">+ Peça rara em casa</a>
                        </li>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright ©
                            peça rara 2022</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Access <a
                                href="https://www.instagram.com/juliucaezar/" target="_blank">instagram by</a>
                            Developer</span>
                    </div>
                </footer>
                <!-- partial -->
